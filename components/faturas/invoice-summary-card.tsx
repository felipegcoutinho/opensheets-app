				...
				<div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
					...
					<DetailItem
						...
						value={
							<Badge
								variant={
									INVOICE_STATUS_BADGE_VARIANT[invoiceStatus]
								}
								className="text-xs"
							>
				...
				<div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
					<DetailItem
						...
						value={
							<span className="font-medium">
								{/* Dia {closingDay && formatDay(closingDay)} */}
								{closingDay ? (
									<span>Dia {formatDay(closingDay)}</span>
								) : (
					...
					<DetailItem
						...
						value={
							<span className="font-medium">
								{dueDay ? (
									<span>Dia {formatDay(dueDay)}</span>
								) : (
									<span className="text-muted-foreground">
										—
									</span>
